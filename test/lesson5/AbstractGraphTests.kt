...
abstract class AbstractGraphTests {
    ...
    fun largestIndependentVertexSet(largestIndependentVertexSet: Graph.() -> Set<Graph.Vertex>) {
        ...
        assertEquals(setOf(graph2["A"], graph2["C"], graph2["F"], graph2["G"], graph2["J"]),
                independent2)
        ...
        assertEquals(setOf(graph3["B"], graph3["E"], graph3["G"], graph3["H"]),
                independent3)
    }
    ...
    fun longestSimplePath(longestSimplePath: Graph.() -> Path) {
        ...
        assertEquals(1, longestPath4.length)
    }
